<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table  :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column align="center" label="联盟名称" width="100">
                <template scope="scope">
                    <span>{{scope.row.leagueName}}</span>
                </template>
            </el-table-column>

            <el-table-column align="center" label="联盟推广地址" width="250">
                <template scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form class="small-space" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;' ref="tempForm">
                ...
                <el-form-item label="联盟名称">
                    <el-select clearable class="filter-item" style="width: 130px" v-model="temp.leagueId" :disabled=" dialogStatus=='update'">
                        <el-option v-for="item in leagueIdOptionsWithoutAll" :key="item.key" :label="item.display_name" :value="item.key">
                        </el-option>
                    </el-select>
                </el-form-item>

                <el-form-item label="联盟url">
                    <el-input v-model="temp.leagueUrl"></el-input>
                </el-form-item>
